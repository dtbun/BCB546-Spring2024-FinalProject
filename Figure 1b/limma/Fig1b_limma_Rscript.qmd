---
title: "Figure 1b R code limma DEA analysis"
format: html
---
...
contr.matrix <- makeContrasts(KOvsWT = PO_Sil - PO, levels = colnames(matrix))
...
write.csv(topTable, "miRNA_limma_fig1b.tsv", row.names=TRUE, col.names=TRUE,quote=FALSE, sep='t') 
...
volcano2_png <- "limma_fig1b_final.png"
...
```{r}
volcano_png <- "heatmap2_fig1b_plot.png"

coolmap(DGE, cluster.by="de pattern", col="yellowblue",
